...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="index.php">CDN</a>
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-10 align-self-end">
                    <h1 class="text-uppercase text-white font-weight-bold">Estadisticas</h1>
                </div>
            </div>
        </div>
    </header>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <div><h3>Pocisiones</h3></div>
                    <?php include('Back/model/statisticsFront/posicions.php'); ?>
                </div>
                <div class="col-6">
                    <div><h3 style="text-align: center;">Calendario</h3></div>
                    <?php include('Back/model/statisticsFront/calendar.php'); ?>
                </div>
            </div>
        </div>
    </section>
