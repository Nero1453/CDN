...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  $longitud = strlen($row['todo']);
  $longitudObj = strlen($row['obj']);
  ?>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <form action="controller/cms/editAbout.php" method="post">
            <label>Quienes Somos</label>
            <input type="text" class="form-control" id="todo" name="todo" size="<?php echo $longitud; ?>"  value="<?php echo $row['todo']; ?>">
            <label>Objetivo</label>
            <input type="text" class="form-control" id="obj" name="obj" size="<?php echo $longitudObj; ?>"  value="<?php echo $row['obj']; ?>">
            <br>
