	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="Back\controller\validacion.php" method="post" class="login100-form validate-form">
					...
					<div class="w-full text-center">
						...
						<hr>
						<a href="index.php" class="txt3" style="color: #555555;">
							Regresar
						</a>
					</div>
				</form>
